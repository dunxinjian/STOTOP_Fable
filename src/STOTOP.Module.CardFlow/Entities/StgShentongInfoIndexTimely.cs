...
/// <summary>
/// STG申通_物流信息及时汇总 暂存表实体。
/// 来源：物流信息指数（excel（物流信息指数）.xls，真 OLE2，含 3 个 sheet，本表对应 sheet「及时性汇总（按天）」，单行表头，15 列）。
/// 1 行/网点/统计日期 的汇总表，本文件无网点编号，仅有网点名称。
/// 15 个业务列全部先以 string? 落地（数量/比率列也是字符串，归一阶段再解析）。
/// </summary>
public class StgShentongInfoIndexTimely : BaseEntity, IStagingRecord
{
    ...
    // 业务字段（15 列，对应 sheet「及时性汇总（按天）」表头）
    public string? F统计日期 { get; set; }
    public string? F网点名称 { get; set; }
    public string? F所属网点名称 { get; set; }
    public string? F揽收总量 { get; set; }
    public string? F揽收上传不及时量 { get; set; }
    public string? F揽收上传不及时率 { get; set; }
    public string? F派件总量 { get; set; }
    public string? F派件上传不及时量 { get; set; }
    public string? F派件上传不及时率 { get; set; }
    public string? F签收总量 { get; set; }
    public string? F签收上传不及时量 { get; set; }
    public string? F签收上传不及时率 { get; set; }
    public string? F扫描总量 { get; set; }
    public string? F上传不及时总量 { get; set; }
    public string? F上传不及时总率 { get; set; }
