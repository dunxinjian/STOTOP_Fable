...
/// 计费结果
/// </summary>
public class ExpBillingResult : BaseEntity, IOrgScoped
{
    ...
    /// <summary>业务对象名称（冗余，加速查询）</summary>
    public string? FPartyClientName { get; set; }
    ...
    /// <summary>成本计算模式 1=标准 2=一口价</summary>
    public int FCostMode { get; set; } = 1;
}
